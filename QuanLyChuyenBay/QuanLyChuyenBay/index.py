...
def RuleChange():
    if request.method.__eq__('POST'):
        ...
        global san_bay_toi_da,gio_mua_toi_da, gio_ban_toi_da, thoi_gian_bay_toi_thieu, san_bay_trung_gian_toi_da, thoi_gian_dung_toi_da, thoi_gian_dung_toi_thieu
        san_bay_toi_da=sbtd
